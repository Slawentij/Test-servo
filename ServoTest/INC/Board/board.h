...
#define LED_DIR          FIO1DIR = LED_MASK  // LED pin  -->  output
#define LED_Off          FIO1SET = LED_MASK
#define LED_On           FIO1CLR = LED_MASK
#define LED_FIO          FIO1PIN

// LCD Pins
#define LCD_CS_MASK      (1UL<<19)
#define LCD_CS_DIR       FIO0DIR |= LCD_CS_MASK  // LCD_CD pin  -->  output
#define LCD_CS_SET       FIO0SET |= LCD_CS_MASK
#define LCD_CS_CLR       FIO0CLR |= LCD_CS_MASK
#define LCD_CS__FIO      FIO0PIN
